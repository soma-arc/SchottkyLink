...
export default class ParallelTranslation extends Generator {
    ...
    exportAsQueryString() {
        return `ParallelTranslation[]=${this.p.x.toFixed(this.digits)},${this.p.y.toFixed(this.digits)},${this.normal.x.toFixed(this.digits)},${this.normal.y.toFixed(this.digits)},${this.planeDist.toFixed(this.digits)}`;
    }
